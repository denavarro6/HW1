...
namespace HW1
{
    ...
    public class CatnipSprite
    {
        ...
        public CatnipSprite(Vector2 position)
        {
            this.Position = position;
            this.bounds = new BoundingRectangle(Position + new Vector2(0, 16), 32, 40);
        }
        ...
        {
            texture = content.Load<Texture2D>("catnip");
        }
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            var source = new Rectangle(0, 0, 128, 160);
            spriteBatch.Draw(texture, Position, source, Color.White, 0, new Vector2(16,-64),.25f, SpriteEffects.None, 0);
        }
    }
}
